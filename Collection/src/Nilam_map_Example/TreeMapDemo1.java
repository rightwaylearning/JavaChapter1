...
public class TreeMapDemo1 {
	public static void main(String[] args) {
		...
		// dec order
		TreeMap<String, Integer> tmap1 = new TreeMap<>(new myownsorting());
		tmap1.put("AA", 11);
		tmap1.put("AA", 22);
		tmap1.put("BB", 33);
		tmap1.put("NN", 44);
		...
		TreeMap<Studentinfo, Integer> tmap2 = new TreeMap<>(new myownsortingimpl());
...
class Studentinfo implements Comparable<Studentinfo> {
	...
	public Studentinfo(Integer rollNumber, String name) {
		super();
...
class myownsortingimpl implements Comparator<Studentinfo> {
